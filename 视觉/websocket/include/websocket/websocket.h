...
class Websocket {
 public:
  ...
  void OnGetNucleus(const std_msgs::msg::Float32::SharedPtr msg);
 private:
  rclcpp::Node::SharedPtr nh_;
  rclcpp::Subscription<sensor_msgs::msg::CompressedImage>::SharedPtr image_sub_;
  rclcpp::Subscription<ai_msgs::msg::PerceptionTargets>::SharedPtr ai_msg_sub_;
  // 注释掉 SubscriptionHbmem，因为在 ROS2 Humble 中不存在
  // rclcpp::SubscriptionHbmem<hbm_img_msgs::msg::HbmMsg1080P>::SharedPtr
  //     image_hbmem_sub_;

  rclcpp::Subscription<std_msgs::msg::Float32>::SharedPtr nucleus_sub_; //核辐射检测
